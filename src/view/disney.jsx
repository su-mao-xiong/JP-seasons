    ...
    <>
        <main className="mt-80">
            ...
            <div className="viewTitle d-flex justify-content-center">
                <img className="me-5" src="/JP-seasons/images/about-base1.png" alt="base1" />
                ...
                <div className="col-md-6 order-md-1 order-1">
                    ...
                    <div className="carousel-inner"> {/*  設定固定高度  */}
                        <div className="carousel-item active">
                            <img src="/JP-seasons/images/article-1-m.png" className="d-block w-100" alt="..." style={{ objectFit: "cover", height: "100%" }} />
                        </div>
                        <div className="carousel-item">
                            <img src="/JP-seasons/images/view_disney.jpg" className="d-block w-100" alt="..." style={{ objectFit: "cover", height: "100%" }} />
                        </div>
                        <div className="carousel-item">
                            <img src="/JP-seasons/images/view_disney1.jpg" className="d-block w-100" alt="..." style={{ objectFit: "cover", height: "100%" }} />
                        </div>
                    </div>
            ...
            <div className="container-xxl mb-80">
                ...
                <div className="from col-md-8 order-md-1 order-1">
                    <h3 className="text-start pm-4">景點評論  5.0 <img src="/JP-seasons/images/star-Icon.png" alt="星星" /></h3>
                    <div className="row align-items-start">
                    {/*  大頭照  */}
                    <div className="head col-md-2 col-3 d-flex flex-column align-items-center">
                        <img className="commentImg profile-img me-3" src="/JP-seasons/images/about-us-4.png" alt="davi#333的頭像" />
                    ...
                    <div className="col-12">
                        ...
                        <div className="me-4">
                            <img className="commentImg profile-img me-3" src="/JP-seasons/images/about-us-1.png" alt="王大明的頭像" />
                            <h5 className="mb-1">王翔明</h5>
                        </div>
                        <div className="">
                            <p className="mb-0">適合帶小孩來玩</p>
                            <div className="mb-1">
                                <span className="review-star"><img src="/JP-seasons/images/star-Icon.png" alt="星星" /><img src="/JP-seasons/images/star-Icon.png" alt="星星" /><img src="/JP-seasons/images/star-Icon.png" alt="星星" /><img src="/JP-seasons/images/star-Icon.png" alt="星星" /><img src="/JP-seasons/images/star-Icon.png" alt="星星" /></span>
                            </div>
                        </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center mb-4">
                        <div className="me-4">
                            <img className="commentImg profile-img me-3" src="/JP-seasons/images/about-us-2.png" alt="蘇大明的頭像" />
                        ...
                        <div className="d-flex align-items-center mb-4">
                        <div className="me-4">
                            <img className="commentImg profile-img me-3" src="/JP-seasons/images/about-us-3.png" alt="謝小華的頭像" />
                        ...
                        <div>
                            ...
                            <div className="mb-2">
                                <span className="review-star" />
                                    <img src="/JP-seasons/images/star-Icon.png" alt="星星" />
                                    <img src="/JP-seasons/images/star-Icon.png" alt="星星" />
                                    <img src="/JP-seasons/images/star-Icon.png" alt="星星" />
                                    <img src="/JP-seasons/images/star-Icon.png" alt="星星" />
                                    <img src="/JP-seasons/images/star-Icon.png" alt="星星" />
                ...
                <div className="tools col-md-2 order-md-2 order-2">
                    ...
                    <div className="tool-link">
                        <img src="/JP-seasons/images/weather.png" alt="雪人"></img>
                    ...
                    <a href="#">
                    <div className="tool-link">
                        <img src="/JP-seasons/images/money.png" alt="錢"></img>
                    ...
                    <a href="#">
                    <div className="tool-link">
                        <img src="/JP-seasons/images/food.png" alt="食物"></img>
                    ...
                    <a href="#">
                    <div className="tool-link">
                        <img src="/JP-seasons/images/tourist.png" alt="富士山"></img>
